...
func (m *RevenueShareUser) Reset()         { *m = RevenueShareUser{} }
func (m *RevenueShareUser) String() string { return proto.CompactTextString(m) }
func (*RevenueShareUser) ProtoMessage()    {}
func (*RevenueShareUser) Descriptor() ([]byte, []int) {
	return fileDescriptor_eda6ab99820fcb49, []int{3}
}
func (m *RevenueShareUser) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *RevenueShareUser) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_RevenueShareUser.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *RevenueShareUser) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RevenueShareUser.Merge(m, src)
}
func (m *RevenueShareUser) XXX_Size() int {
	return m.Size()
}
func (m *RevenueShareUser) XXX_DiscardUnknown() {
	xxx_messageInfo_RevenueShareUser.DiscardUnknown(m)
}

var xxx_messageInfo_RevenueShareUser proto.InternalMessageInfo

func (m *RevenueShareUser) GetUserAddress() string {
	if m != nil {
...
func (m *RevenueShareUser) GetParents() []string {
	if m != nil {
		return m.Parents
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*RevenueShareUser)(nil), "osmosis.poolmanager.v1beta1.RevenueShareUser")
}
...
var fileDescriptor_eda6ab99820fcb49 = []byte{
	...
	,
}
...
func (m *RevenueShareUser) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *RevenueShareUser) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *RevenueShareUser) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.Parents) > 0 {
		for iNdEx := len(m.Parents) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintTakerFeeShare(dAtA, i, uint64(len(m.Parents[iNdEx])))
			i--
			dAtA[i] = 0x12
		}
	}
	if len(m.UserAddress) > 0 {
		...
		i = encodeVarintTakerFeeShare(dAtA, i, uint64(len(m.UserAddress)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *RevenueShareUser) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *RevenueShareUser) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RevenueShareUser: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RevenueShareUser: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
